  ...
  class AllGenerations
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PvaultSdk::AllGenerations` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PvaultSdk::AllGenerations`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'workers')
        if (value = attributes[:'workers']).is_a?(Array)
          self.workers = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @vault.nil?
        invalid_properties.push('invalid value for "vault", vault cannot be nil.')
      end

      if @workers.nil?
        invalid_properties.push('invalid value for "workers", workers cannot be nil.')
      end
