...
module PvaultSdk
  class ConfigExpiration
    ...
    attr_accessor :unassociated_objects
    ...
    def self.attribute_map
      {
        ...
        :'tokens' => :'tokens',
        :'unassociated_objects' => :'unassociated_objects'
      }
    end
    ...
    def self.openapi_types
      {
        :'associated_objects' => :'Integer',
        :'tokens' => :'Integer',
        :'unassociated_objects' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PvaultSdk::ConfigExpiration` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PvaultSdk::ConfigExpiration`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'unassociated_objects')
        self.unassociated_objects = attributes[:'unassociated_objects']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @unassociated_objects.nil?
        invalid_properties.push('invalid value for "unassociated_objects", unassociated_objects cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @unassociated_objects.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          tokens == o.tokens &&
          unassociated_objects == o.unassociated_objects
    end
    ...
    def hash
      [associated_objects, tokens, unassociated_objects].hash
    end
