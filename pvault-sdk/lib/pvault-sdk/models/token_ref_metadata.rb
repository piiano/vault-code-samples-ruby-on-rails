...
module PvaultSdk
  class TokenRefMetadata
    ...
    attr_accessor :effective_expiration_time
    ...
    def self.openapi_types
      {
        :'creation_time' => :'Time',
        :'effective_expiration_time' => :'Time',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PvaultSdk::TokenRefMetadata` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PvaultSdk::TokenRefMetadata`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'effective_expiration_time')
        self.effective_expiration_time = attributes[:'effective_expiration_time']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          effective_expiration_time == o.effective_expiration_time &&
    ...
    def hash
      [creation_time, effective_expiration_time, expiration_time, object_id, tags].hash
    end
