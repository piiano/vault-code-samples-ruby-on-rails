  ...
  class ConfigGC
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PvaultSdk::ConfigGC` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PvaultSdk::ConfigGC`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'retention_period_days')
    ...
    def list_invalid_properties
      ...
      if @retention_period_days.nil?
        invalid_properties.push('invalid value for "retention_period_days", retention_period_days cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @retention_period_days.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          retention_period_days == o.retention_period_days
    end
    ...
    def hash
      [batch_size, retention_period_days].hash
    end
